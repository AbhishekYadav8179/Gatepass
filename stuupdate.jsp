...
try{
	...
	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/gatepass","root","bollaveni8179");
  ...
  <%
   ...
   stmt.executeUpdate("update student_details set roll_no='"+rno+"',first_name='"+fnm+"',middle_name='"+mnm+"',last_name='"+lnm+"',branch='"+b+"',section='"+sec+"',contact_no='"+ph+"',pin='"+pin+"' where roll_no='"+rno+"'");
	...
	stmt.executeUpdate("update student_parent set parent_name='"+fname+"',parent_ph='"+fph +"',roll_no='"+rno+"' where roll_no='"+rno+"'");
	con.close();
}
