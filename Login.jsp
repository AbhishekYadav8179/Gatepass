...
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/books", "root", "bollaveni8179");
Statement st=conn.createStatement();

 //st = conn.createStatement();
 String sql ="insert into book(bid,author,price) values(12,'Abhishek',125.5)";
